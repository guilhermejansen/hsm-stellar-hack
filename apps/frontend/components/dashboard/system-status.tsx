  ...
  return (
    <Card className="corporate-card">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          {Object.entries(components).map(([name, info]: [string, any]) => {
            ...
            return (
              <div 
                key={name}
                className="flex items-center justify-between p-3 border border-corporate-200 dark:border-corporate-700 rounded-lg hover:bg-corporate-50 dark:hover:bg-corporate-800 transition-colors"
              >
                <div className="flex items-center space-x-3">
                  <IconComponent className="w-4 h-4 text-corporate-600 dark:text-corporate-300" />
                  <div>
                    <div className="font-medium text-corporate-900 dark:text-corporate-100 capitalize">
        ...
        {/* mTLS Status */}
        <div className="border-t border-corporate-200 dark:border-corporate-700 pt-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Shield className="w-4 h-4 text-corporate-600 dark:text-corporate-300" />
          ...
          <p className="text-xs text-corporate-500 dark:text-corporate-400 mt-1">
        ...
        {/* Environment Info */}
        <div className="border-t border-corporate-200 dark:border-corporate-700 pt-4">
          <div className="text-xs text-corporate-500 dark:text-corporate-400 space-y-1">
