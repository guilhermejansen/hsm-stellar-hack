            ...
            {user?.isGuardian ? (
              <>
                ...
                <Badge variant={user.hsmActivated ? 'success' : 'warning'} className="ml-2">
                  {user.hsmActivated ? 'HSM Active' : 'HSM Pending'}
                </Badge>
              </>
            ) : (
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center p-4 bg-stellar-50 rounded-lg">
                <div className="text-2xl font-bold text-stellar-700">{user.role}</div>
                <div className="text-sm text-stellar-600">Guardian Role</div>
              </div>
              <div className="text-center p-4 bg-corporate-50 rounded-lg">
                <div className="text-2xl font-bold text-corporate-700">Level {user.level || 1}</div>
                <div className="text-sm text-corporate-600">Permission Level</div>
              </div>
              <div className="text-center p-4 bg-success-50 rounded-lg">
                <div className={cn(
                  'text-2xl font-bold',
                  user.hsmActivated ? 'text-success-700' : 'text-warning-700'
                )}>
