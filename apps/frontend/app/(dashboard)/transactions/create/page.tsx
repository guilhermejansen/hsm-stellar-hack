  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-corporate-900">Create Transaction</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="corporate-card">
              ...
              <CardContent className="space-y-4">
                ...
                {selectedWallet && (
                  <div className="p-4 bg-corporate-50 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <span className="font-medium text-corporate-700">Source Wallet</span>
                      <WalletTypeBadge type={selectedWallet.walletType} />
                    </div>
                    <div className="space-y-1 text-sm">
                      <div>Balance: {formatXLMWithSuffix(selectedWallet.balance)}</div>
                      <div>Path: <code className="bg-corporate-100 px-1 rounded">{selectedWallet.derivationPath}</code></div>
                      <div>TOTP Required: {selectedWallet.requiresTOTP ? 'Yes' : 'No'}</div>
                    </div>
                  </div>
                )}
                ...
                {thresholdInfo && (
                  <div className="space-y-3">
                    <div className="p-4 bg-gradient-to-r from-stellar-50 to-warning-50 rounded-lg border">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-medium text-corporate-700">Approval Scheme</span>
                        <Badge variant={thresholdInfo.required === 3 ? 'error' : 'warning'}>
                          {thresholdInfo.required}-of-{thresholdInfo.total}
                        </Badge>
                      </div>
                      <p className="text-sm text-corporate-600">{thresholdInfo.description}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-3 bg-white rounded border">
                        <div className="text-sm text-corporate-600">Required Approvals</div>
                        <div className="text-lg font-bold text-warning-700">
                          {thresholdInfo.required} Guardians
                        </div>
                      </div>
                      <div className="p-3 bg-white rounded border">
                        <div className="text-sm text-corporate-600">Challenge Type</div>
                        <div className="text-lg font-bold text-corporate-700">
            ...
            <Card className="corporate-card bg-gradient-to-br from-stellar-50 to-corporate-50">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center p-4 bg-white rounded-lg">
                    <div className="text-sm text-corporate-600">Approval Required</div>
                  ...
                  <div className="text-center p-4 bg-white rounded-lg">
                    <div className="text-sm text-corporate-600">Estimated Fee</div>
