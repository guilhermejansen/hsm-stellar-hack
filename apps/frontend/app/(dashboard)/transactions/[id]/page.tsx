  ...
  if (!transaction?.data) {
    return (
      <div className="text-center py-12">
        <h1 className="text-2xl font-bold text-corporate-900 mb-4">Transaction Not Found</h1>
        ...
        <Card className="corporate-card">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <div>
                <div className="text-sm text-corporate-600">Type</div>
                <Badge variant="outline">{tx.txType}</Badge>
              </div>
              
              {tx.memo && (
                <div>
                  <div className="text-sm text-corporate-600">Memo</div>
                  <div className="text-sm text-corporate-900 bg-corporate-50 p-2 rounded">
                    {tx.memo}
                  </div>
                </div>
              )}
              ...
              <div>
                <div className="text-sm text-corporate-600">Created</div>
                <div className="text-sm text-corporate-900">{formatDate(tx.createdAt)}</div>
              </div>
              
              {tx.executedAt && (
                <div>
                  <div className="text-sm text-corporate-600">Executed</div>
                  <div className="text-sm text-corporate-900">{formatDate(tx.executedAt)}</div>
                </div>
              )}
            </div>
          </CardContent>
        ...
        <Card className="corporate-card">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              ...
              <div>
                <div className="text-sm text-corporate-600">Address</div>
                <div className="flex items-center space-x-2">
                  <code className="text-sm bg-corporate-100 px-2 py-1 rounded flex-1">
              ...
              <div>
                <div className="text-sm text-corporate-600">Derivation Path</div>
                <code className="text-sm bg-corporate-100 px-2 py-1 rounded">
              ...
              <div>
                <div className="text-sm text-corporate-600">Destination</div>
                <div className="flex items-center space-x-2">
                  <code className="text-sm bg-corporate-100 px-2 py-1 rounded flex-1">
          ...
          <CardContent className="space-y-4">
            {tx.privacyProtection?.isPrivacyProtected ? (
              <div className="space-y-3">
                ...
                <div>
                  <div className="text-sm text-corporate-600">Ephemeral Address</div>
                  <div className="flex items-center space-x-2">
                    <code className="text-sm bg-success-100 px-2 py-1 rounded flex-1">
                ...
                <div>
                  <div className="text-sm text-corporate-600">Transaction Index</div>
                  <div className="text-sm text-corporate-900">
                    #{tx.privacyProtection.transactionIndex}
                  </div>
                </div>
                
                <div className="space-y-2 pt-2 border-t border-corporate-200">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-corporate-600">Key Used</span>
                    <Badge variant={tx.privacyProtection.keyStatus.isUsed ? 'success' : 'warning'}>
                      {tx.privacyProtection.keyStatus.isUsed ? 'Yes' : 'No'}
                    </Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-corporate-600">Key Destroyed</span>
              ...
              <div className="text-center py-4">
                ...
                <p className="text-sm text-corporate-600 mt-2">
