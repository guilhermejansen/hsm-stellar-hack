  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-corporate-900">Wallet Management</h1>
        ...
        <CardContent>
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  <div className="inline-flex items-center px-4 py-2 bg-corporate-100 rounded-lg border border-corporate-200">
                    ...
                    <span className="font-mono text-sm">Ephemeral Keys (m/0'/0'/N')</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="font-medium text-corporate-900">Current Distribution</h4>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-stellar-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="font-mono text-sm">{formatPercentage(balances?.data?.cold?.percentage || 0)}</div>
                      <div className="text-xs text-corporate-500">Target: 95%</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-warning-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="font-mono text-sm">{formatPercentage(balances?.data?.hot?.percentage || 0)}</div>
                      <div className="text-xs text-corporate-500">Target: 5%</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h4 className="font-medium text-corporate-900">Rebalancing Status</h4>
