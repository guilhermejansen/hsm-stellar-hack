  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-corporate-900">Guardian Management</h1>
          <p className="text-corporate-600 mt-1">
            Manage the 3-guardian system (CEO, CFO, CTO) with HSM security
          </p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-corporate-50 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-corporate-700">Minimum Guardians</span>
                <SystemHealthBadge 
            ...
            <div className="p-4 bg-corporate-50 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-corporate-700">System Operational</span>
                <SystemHealthBadge 
            ...
            <div className="p-4 bg-corporate-50 rounded-lg">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-corporate-700">Completion Rate</span>
        ...
        <CardContent>
          {guardiansLoading ? (
                  ...
                  <TableRow key={guardian.id}>
                    ...
                    <TableCell>
                      <div className="space-y-1 text-sm">
                        <div>Daily: {formatXLMWithSuffix(guardian.dailyLimit)}</div>
                        <div>Monthly: {formatXLMWithSuffix(guardian.monthlyLimit)}</div>
                      </div>
                    </TableCell>
                    
                    <TableCell>
                      <div className="space-y-1 text-sm">
                        <div className="font-medium">{guardian.totalApprovals} approvals</div>
            ...
            <div className="text-center py-12">
              <Users className="w-16 h-16 text-corporate-300 mx-auto mb-4" />
