  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-corporate-900 dark:text-corporate-100">Privacy Protection</h1>
                ...
                {privacyReport?.data?.privacy?.privacyBenefits?.map((benefit, index) => (
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-2">
                      ...
                      <span className="text-sm text-corporate-600 dark:text-corporate-300">External observers cannot correlate transactions</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-success-500 mt-0.5" />
                      <span className="text-sm text-corporate-600 dark:text-corporate-300">Each transaction appears from random address</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-success-500 mt-0.5" />
                      <span className="text-sm text-corporate-600 dark:text-corporate-300">Wallet balances cannot be traced</span>
                    </div>
                    <div className="flex items-start space-x-2">
                      <CheckCircle className="w-4 h-4 text-success-500 mt-0.5" />
                      <span className="text-sm text-corporate-600 dark:text-corporate-300">Complete financial privacy protection</span>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-3">
                {privacyReport?.data?.recommendations?.map((rec, index) => (
                  <div key={index} className="flex items-start space-x-2">
                    ...
                    <span className="text-sm text-corporate-600 dark:text-corporate-300">{rec}</span>
                  </div>
                )) || (
                  <div className="flex items-start space-x-2">
                    <CheckCircle className="w-4 h-4 text-success-500 mt-0.5" />
                    <span className="text-sm text-corporate-600 dark:text-corporate-300">Privacy protection operating optimally</span>
                  </div>
                )}
              </div>
            </div>
      ...
      <Card className="corporate-card">
        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="bg-corporate-50 dark:bg-corporate-800 rounded-lg p-6">
              <h4 className="font-medium text-corporate-900 dark:text-corporate-100 mb-4">Key Derivation Hierarchy</h4>
              <div className="space-y-4">
                <div className="text-center">
                  <div className="inline-flex items-center px-4 py-2 bg-stellar-100 dark:bg-stellar-900/30 rounded-lg">
                    <Shield className="w-4 h-4 mr-2 text-stellar-600" />
                    <span className="font-mono text-sm text-corporate-900 dark:text-corporate-100">Master Key (m)</span>
                  </div>
                  <div className="text-xs text-corporate-500 dark:text-corporate-400 mt-1">Root in HSM partition</div>
                </div>

                <div className="flex justify-center">
                  <div className="w-px h-6 bg-corporate-300 dark:bg-corporate-600"></div>
                </div>

                <div className="text-center">
                  <div className="inline-flex items-center px-4 py-2 bg-stellar-100 dark:bg-stellar-900/30 rounded-lg">
                    <span className="font-mono text-sm text-corporate-900 dark:text-corporate-100">Cold Wallet (m/0')</span>
                  </div>
                  <div className="text-xs text-corporate-500 dark:text-corporate-400 mt-1">95% of funds - Static address</div>
                </div>
                ...
                <div className="text-center">
                  <div className="inline-flex items-center px-4 py-2 bg-warning-100 dark:bg-warning-900/30 rounded-lg">
                    <span className="font-mono text-sm text-corporate-900 dark:text-corporate-100">Hot Wallet (m/0'/0')</span>
                  </div>
                  <div className="text-xs text-corporate-500 dark:text-corporate-400 mt-1">5% of funds - Static address</div>
                </div>
                ...
                <div className="text-center">
                  <div className="inline-flex items-center px-4 py-2 bg-success-100 dark:bg-success-900/30 rounded-lg">
                    <RefreshCw className="w-4 h-4 mr-2 text-success-600" />
                    <span className="font-mono text-sm text-corporate-900 dark:text-corporate-100">Transaction Keys (m/0'/0'/N')</span>
                  </div>
                  <div className="text-xs text-corporate-500 dark:text-corporate-400 mt-1">NEW ADDRESS per transaction</div>
                </div>
              </div>
            </div>
