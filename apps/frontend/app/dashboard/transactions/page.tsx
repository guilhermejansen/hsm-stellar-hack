  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-corporate-900 dark:text-corporate-100">Transaction Management</h1>
      ...
      <Card className="corporate-card">
        ...
        <CardContent>
          <TransactionVolumeChart 
            data={[
              { date: '2025-09-12', volume: 45000, transactions: 12 },
              { date: '2025-09-13', volume: 52000, transactions: 15 },
              { date: '2025-09-14', volume: 38000, transactions: 8 },
              { date: '2025-09-15', volume: 67000, transactions: 18 },
              { date: '2025-09-16', volume: 71000, transactions: 22 },
            ]}
          />
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="space-y-2">
              <label className="text-sm font-medium text-corporate-700 dark:text-corporate-300">Status</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-corporate-700 dark:text-corporate-300">Type</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-corporate-700 dark:text-corporate-300">Search</label>
        ...
        <CardContent>
          {transactionsLoading ? (
            ...
            <div className="text-center py-12">
              <ArrowRightLeft className="w-16 h-16 text-corporate-300 dark:text-corporate-600 mx-auto mb-4" />
