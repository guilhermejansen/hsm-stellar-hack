  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-corporate-900 dark:text-corporate-100">System Monitoring</h1>
          ...
          {healthLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-white dark:bg-corporate-800 rounded-lg">
                ...
                <div className="font-bold text-lg text-corporate-900 dark:text-corporate-100">
              ...
              <div className="text-center p-4 bg-white dark:bg-corporate-800 rounded-lg">
                <div className="text-sm text-corporate-600 dark:text-corporate-300">Environment</div>
                <div className="font-bold text-corporate-900 dark:text-corporate-100">{systemHealth.data.environment}</div>
                <Badge variant="outline" className="mt-1">{systemHealth.data.version}</Badge>
              </div>
              
              <div className="text-center p-4 bg-white dark:bg-corporate-800 rounded-lg">
                <div className="text-sm text-corporate-600 dark:text-corporate-300">mTLS Security</div>
                <div className="font-bold text-corporate-900 dark:text-corporate-100">
              ...
              <div className="text-center p-4 bg-white dark:bg-corporate-800 rounded-lg">
                <div className="text-sm text-corporate-600 dark:text-corporate-300">Last Check</div>
                <div className="font-bold text-corporate-900 dark:text-corporate-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {Object.entries(systemHealth.data.components).map(([name, info]: [string, any]) => {
                ...
                return (
                  <div 
                    key={name}
                    className="p-4 border border-corporate-200 dark:border-corporate-700 rounded-lg hover:bg-corporate-50 dark:hover:bg-corporate-800 transition-colors"
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        <IconComponent className="w-5 h-5 text-corporate-600 dark:text-corporate-300" />
                        <span className="font-medium text-corporate-900 dark:text-corporate-100 capitalize">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex items-center justify-between">
                        <span className="text-corporate-600 dark:text-corporate-300">Latency:</span>
                        <span className="font-mono text-corporate-900 dark:text-corporate-100">{info.latency}ms</span>
                      </div>
                      
                      {info.partitions && (
                        <div className="flex items-center justify-between">
                          <span className="text-corporate-600 dark:text-corporate-300">Partitions:</span>
                          <span className="font-mono text-corporate-900 dark:text-corporate-100">{info.partitions}</span>
                        </div>
                      )}
                      
                      {info.network && (
                        <div className="flex items-center justify-between">
                          <span className="text-corporate-600 dark:text-corporate-300">Network:</span>
                      ...
                      {info.latestLedger && (
                        <div className="flex items-center justify-between">
                          <span className="text-corporate-600 dark:text-corporate-300">Latest Ledger:</span>
                          <span className="font-mono text-corporate-900 dark:text-corporate-100">{info.latestLedger}</span>
                        </div>
                      )}
                    </div>
                  </div>
